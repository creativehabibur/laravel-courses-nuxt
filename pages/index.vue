        ...
        <div class="bg-white rounded grap-10 overflow-hidden shadow-card">
          ...
          <div class="px-6 pb-5">
            <div class="mt-7 flex justify-between items-center gap-4 mb-4">
              <router-link to="/" class="text-lg-primary w-full hover:underline">Laravel Core Adventures</router-link>
            </div>
            <div>
      ...
      <div class="container mx-auto px-8 w-full flex flex-row justify-between items-center gap-5 h-full">
        <div class="max-w-[579px] w-full">
          ...
          <div class="mt-6 md:mt-12 w-full flex flex-col sm:flex-row items-center gap-5">
            <input type="email" placeholder="Your email address" class="md:max-w-[385px] input-focus w-full h-14 bg-white border border-orange rounded-lg px-3.5 text-base-primary text-[#262626] placeholder:text-current outline-none">
...
<script setup>
const { data: courses } = await useFetch('https://laravel_courses.test/api/courses')
